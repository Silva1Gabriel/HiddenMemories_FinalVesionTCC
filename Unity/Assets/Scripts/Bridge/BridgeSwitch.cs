...
{
    // Apesar do nome, o código agora é usado para controlar a porta presente no terreno, onde é verificado se o painel de controle foi ativado, se for verdadeiro a animação da porta toca e ela se abre liberando caminho.
