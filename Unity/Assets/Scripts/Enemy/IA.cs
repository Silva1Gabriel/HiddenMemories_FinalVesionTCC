...
{
    // Inimigo utilizado na demo, porém só foi utilizada a parte da ativação da perseguição, porém o código é bem mais complexo, avaliando os pontos extremos do jogador,cabeça e pés, onde se o inimigo avistar uma das duas partes iniciará a perseguição.
    ...
    public void Update()
    {
        ...
        if (isAware)
        {//ativa o inimigo e suas animações;
