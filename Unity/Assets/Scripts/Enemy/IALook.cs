...
{
   // Código também não aplicado a demo, onde o inimigo faz a função de um sentinela, parado em seu lugar ele observa uma área e se o jogador entrar em seu campo de ação uma ação pode ser executada (ataque, perseguição, etc);
